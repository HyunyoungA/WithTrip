...
public class OrderController {
   ...
   @RequestMapping("paymentDetail.od")
    ...
    public int rcancelPay(@RequestBody Order gOrder, HttpServletRequest request, HttpServletResponse response) throws Exception {
       ...
       String imp_key = URLEncoder.encode("4245827895915431", "UTF-8");
       String imp_secret =   URLEncoder.encode("9a2da4bc100151cdbff69679a4ba13a40ee6388d3693a3268559055d29cadb0bb9a43ad48d21aca3", "UTF-8");
...
// 여기부터 결제 검증에 필요
   ...
   public OrderController() {
	   ...
	   this.api = new IamportClient("4245827895915431","9a2da4bc100151cdbff69679a4ba13a40ee6388d3693a3268559055d29cadb0bb9a43ad48d21aca3");
   }
