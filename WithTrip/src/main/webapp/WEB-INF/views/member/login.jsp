...
<!-- background: linear-gradient(270deg, rgba(140,175,242,1) 15%, rgba(126,169,242,1) 38%, rgba(110,156,236,1) 61%);" id="loginBtn" ><span>로그인<br></span></button> -->
 ...
 background: linear-gradient(270deg, rgba(140,175,242,1) 15%, rgba(126,169,242,1) 38%, rgba(110,156,236,1) 61%);" id="loginBtn" ><span>로그인<br></span></button> 
	...
	<a class="p-2" href="https://kauth.kakao.com/oauth/authorize?client_id=f5f9425687ec5ab69784b8b04dc37b9c&redirect_uri=http://localhost:9680/WithTrip/kakao.me&response_type=code">
